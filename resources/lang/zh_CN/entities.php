...
return [
    ...
    'recently_created_chapters' => '最近创建的分组',
    'recently_created_books' => '最近创建的项目',
    'recently_created_shelves' => '最近创建的空间',
    ...
    'shelf' => '空间',
    'shelves' => '空间',
    'x_shelves' => ':count 空间|:count 空间',
    'shelves_long' => '空间',
    'shelves_empty' => '当前未创建空间',
    'shelves_create' => '创建新空间',
    'shelves_popular' => '热门空间',
    'shelves_new' => '新空间',
    'shelves_new_action' => '新空间',
    'shelves_popular_empty' => '最热门的空间',
    'shelves_new_empty' => '最新创建的空间',
    'shelves_save' => '保存空间',
    'shelves_books' => '项目已在此空间里',
    'shelves_add_books' => '将项目加入此空间',
    'shelves_drag_books' => '拖动项目将其添加到此空间',
    'shelves_empty_contents' => '这个空间没有分配项目',
    'shelves_edit_and_assign' => '编辑空间以分配项目',
    'shelves_edit_named' => '编辑空间 :name',
    'shelves_edit' => '编辑空间',
    'shelves_delete' => '删除空间',
    'shelves_delete_named' => '删除空间 :name',
    'shelves_delete_explain' => "此操作将删除空间 ':name'。 其中包含的项目不会被删除。",
    'shelves_delete_confirmation' => '您确定要删除此空间吗？',
    'shelves_permissions' => '空间权限',
    'shelves_permissions_updated' => '空间权限已更新',
    'shelves_permissions_active' => '空间权限激活',
    'shelves_permissions_cascade_warning' => '空间上的权限不会自动应用到空间里的项目。这是因为项目可以在多个空间上存在。使用下面的选项可以将权限复制到空间里的项目上。',
    'shelves_copy_permissions_to_books' => '将权限复制到项目',
    'shelves_copy_permissions' => '复制权限',
    'shelves_copy_permissions_explain' => '这会将此空间的当前权限设置应用于其中包含的所有项目。 在激活之前，请确保已保存对此空间权限的任何更改。',
    'shelves_copy_permission_success' => '空间权限复制到项目 :count ',

    // Books
    'book' => '项目',
    'books' => '项目',
    'x_books' => ':count 本项目',
    'books_empty' => '不存在已创建的项目',
    'books_popular' => '热门项目',
    'books_recent' => '最近的项目',
    'books_new' => '新项目',
    'books_all' => '所有项目',
    ...
    'books_create' => '创建项目',
    'books_delete' => '删除项目',
    'books_delete_named' => '删除项目「:bookName」',
    'books_delete_explain' => '这将删除项目「:bookName」。所有的分组和页面都会被删除。',
    'books_delete_confirmation' => '您确定要删除此项目吗？',
    'books_edit' => '编辑项目',
    'books_edit_named' => '编辑项目「:bookName」',
    'books_form_book_name' => '项目名',
    'books_save' => '保存项目',
    'books_permissions' => '项目权限',
    'books_permissions_updated' => '项目权限已更新',
    'books_empty_contents' => '本项目目前没有页面或分组。',
    'books_empty_create_page' => '创建页面',
    'books_empty_sort_current_book' => '排序当前项目',
    ...
    'books_sort_chapters_first' => '分组正序',
    'books_sort_chapters_last' => '分组倒序',
    'books_sort_show_other' => '显示其他项目',
    'books_sort_save' => '保存新顺序',
    'books_copy' => '复制项目',
    'books_copy_success' => '项目已成功复制',

    // Chapters
    'chapter' => '分组',
    'chapters' => '分组',
    'x_chapters' => ':count个分组',
    'chapters_popular' => '热门分组',
    'chapters_new' => '新分组',
    'chapters_create' => '创建分组',
    'chapters_delete' => '删除分组',
    'chapters_delete_named' => '删除分组「:chapterName」',
    'chapters_delete_explain' => '这将删除名为“:chapterName”的分组。本分组中存在的所有页面也将被删除。',
    'chapters_delete_confirm' => '您确定要删除此分组吗？',
    'chapters_edit' => '编辑分组',
    'chapters_edit_named' => '编辑分组「:chapterName」',
    'chapters_save' => '保存分组',
    'chapters_move' => '移动分组',
    'chapters_move_named' => '移动分组「:chapterName」',
    'chapter_move_success' => '分组移动到「:bookName」',
    'chapters_copy' => '复制分组',
    'chapters_copy_success' => '分组已成功复制',
    'chapters_permissions' => '分组权限',
    'chapters_empty' => '本分组目前没有页面。',
    'chapters_permissions_active' => '有效的分组权限',
    'chapters_permissions_success' => '分组权限已更新',
    'chapters_search_this' => '从本分组搜索',
    ...
    'pages_not_in_chapter' => '本页面不在某分组中',
    'pages_move' => '移动页面',
    ...
    'tags_assigned_chapters' => '有这个标签的分组',
    'tags_assigned_books' => '有这个标签的项目',
    'tags_assigned_shelves' => '有这个标签的空间',
    'tags_x_unique_values' => ':count 个不重复项目',
    'tags_all_values' => '所有值',
    'tags_view_tags' => '查看标签',
    'tags_view_existing_tags' => '查看已有的标签',
    'tags_list_empty_hint' => '您可以在页面编辑器的侧边栏添加标签，或者在编辑项目、分组、空间时添加。',
    'attachments' => '附件',
    ...
    'profile_not_created_chapters' => ':userName尚未创建任何分组',
    'profile_not_created_books' => ':userName尚未创建任何项目',
    'profile_not_created_shelves' => ':userName 尚未创建任何空间',
